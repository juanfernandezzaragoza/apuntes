...
- **Qué son los problemas de cooperación**
	- Esto hace que no sea un problema de cooperacion respirar, ni generar datos en google maps.  
		...
		Esto es importante xq lo q hacen las plataformas no es promover la cooperacion, sino encarar el problema de suma positiva (con el poder se entrar y sacar al resto).  
