...
- Clasificación de tejidos en escalas y niveles (y explicación de por qué no)...
	- Qué significa el nivel de la cooperación 
		...
		- También puede haber externalidades. La *transacción* puede tener externalidades.
...
- **Qué son los problemas de cooperación**
	- Esto hace que no sea un problema de cooperación respirar, ni generar datos en Google Maps.  
		...
		Esto es importante porque lo que hacen las plataformas no es promover la cooperación, sino encarar el problema de suma positiva (con el poder de entrar y sacar al resto).  
