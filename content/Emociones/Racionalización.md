...
Por ejemplo: si el [efecto arrastre](https://es.wikipedia.org/wiki/Efecto_arrastre) hace que alguien adopte una creencia porque también la adoptaron sus pares, una racionalización posible sería construir, después del hecho, una justificación argumental de por qué esa creencia era más razonable que las alternativas.
